...
function CachedImageView(imageDirectoryName) {
	self._imageDirectoryName;
}   

CachedImageView.prototype.cache = function( url, imageViewObject ) {
	// Grab the filename
	var filename = url.split('/');
	var imageDirectoryName = self._imageDirectoryName;
