(function() {	
	 ...
	 */
	movies.datetime.strtotime = function (str, now) {
	...
	movies.datetime.prettyDate = function (time) {
	...
	movies.datetime.getTwitterInterval = function (strDateTime) {
	    return movies.datetime.prettyDate(movies.datetime.strtotime(strDateTime));
	};
	
	movies.datetime.dayToName = function (day) {
	    switch (day) {
	    case 0:
	        return 'Sunday';
	    case 1:
	...
	movies.datetime.monthToName = function (month) {
	    switch (month) {
	    case 1:
	        return 'January';
	    case 2:
	...
	movies.datetime.cleanDate = function (date) {
	    var label;
	    switch (date.getDate()) {
	    case 1:
	        label = 'st';
	    ...
	    return movies.datetime.dayToName(date.getDay()) + ', ' + movies.datetime.monthToName(date.getMonth() + 1) + ' ' + date.getDate() + label;
	};
	
	movies.datetime.cleanTime = function (time) {
